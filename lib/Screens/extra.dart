...
class _Handyman_Reviews_ScreenState extends State<Handyman_Reviews_Screen> {
  List<Ratings> ratings = [
    Ratings(name: "John Doe", review: "This product is great!", rating: 5.0),
    Ratings(name: "Jane Doe", review: "This product is okay.", rating: 3.0),
    Ratings(
        name: "Peter Jones",
        review: "I would not recommend this product.",
        rating: 1.0),
    Ratings(
        name: "Mary Smith",
        review: "This product is pretty good.",
        rating: 4.0),
    Ratings(name: "David Brown", review: "I love this product!", rating: 5.0),
  ];
  @override
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(
                                                  text:
                                                      'Nothing to complain. A good guy with good service. Hope to have him sent to the next service or',
                                                  style: SafeGoogleFont(
                                                    'Inter',
                                                    fontSize: 12 * ffem,
                                                    fontWeight: FontWeight.w400,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          margin: EdgeInsets.fromLTRB(52 * fem,
                                              0 * fem, 53 * fem, 0 * fem),
                                          width: double.infinity,
                                          height: 61 * fem,
                                          child: Stack(

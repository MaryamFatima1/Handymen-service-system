          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 438 * fem),
                padding: EdgeInsets.fromLTRB(
                    40 * fem, 62 * fem, 40 * fem, 39.31 * fem),
                width: double.infinity,
                decoration: BoxDecoration(
